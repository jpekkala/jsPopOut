 ...
 * "handicapping rules". The handicapping rules require the first player to win
 * within 21 plies and does not allow him to make a pop move unless it leads to
 * an immediate him. In other words, a loss for the first player does not
